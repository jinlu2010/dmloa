		...
		<form @submit="formSubmit" @reset="formReset">
			<view class="form">
				<view class="form-item">
					...
					<input class="input" name="taskname" value="办理入职手续" />
				</view>
				<view class="form-item">
				...
				<view class="form-item">
					...
					<picker @change="bindPickerChange3" :value="index3" :range="array3" range-key="name">
						<view class="input">{{array3[index3].name}}
							<uni-icons type="arrowdown" size="12" color="#999" class="pl20"></uni-icons>
						</view>
					</picker>
				</view>					
				<view class="form-item other-radio" v-if="show">
	...
	export default {
		...
		data() {
			return {
				...
				index2: 1,
				array3: [{name:'进行'},{name: '终止'},{name: '改派'}],
				index3: 0,
				date: getDate({
					format: true
				}),
